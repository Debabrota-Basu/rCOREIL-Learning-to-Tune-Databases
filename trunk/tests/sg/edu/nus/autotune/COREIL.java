...
public class OptimizerWhatIfFree extends Execution {
    ...
    public OptimizerWhatIfFree(DataConnectivity data) throws SQLException {
        super(data);
        _data = (DB2DATA) data;
    ...
    protected int run() throws Exception {
        ...
        LeastSquare LS_eta = new LeastSquare(DB2DATA.getNumOfIndexes() * 2 - 1);
        ...
        LOG.info("# COREIL with " + DB2DATA.workload + " with " + _gamma);
        _output.write("# COREIL with " + DB2DATA.workload + " with " + _gamma);
